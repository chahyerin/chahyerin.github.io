...
export default function ContactForm ({}) {
    ...
    const handleSubmitForm = handleSubmit((data) => {
        console.log({data});
        emailjs.send('service_camt41p', 'template_nuxxtrq', data, 'rYAwizeij8MKwkSFH')
    ...
    return (
        <>
            ...
            <div className={'w-full text-4xl font-bold leading-[44px] mt-8'}>안녕하세요,<br/>프로젝트에 대해 설명해주세요.</div>
                <div className={'flex gap-8 mt-[52px]'}>
                    <Form.InputGroup className={'w-full'}>
                        <Form.Label htmlFor={'companyName'} required>회사명</Form.Label>
                        <Form.Input id={'companyName'} {...register("companyName", { required: true })} placeholder="text" />
                    </Form.InputGroup>
                    <Form.InputGroup className={'w-full'}>
                        <Form.Label htmlFor={'managerName'} required>담당자명</Form.Label>
                ...
                <div className={'flex gap-8 mt-3'}>
                    ...
                    <Form.InputGroup className={'w-full'}>
                        <Form.Label htmlFor={'managerContact'} required>연락처</Form.Label>
                ...
                <div className={'flex gap-8 mt-3'}>
                    <Form.InputGroup className={'w-full'}>
                        <Form.Label htmlFor={'budget'} required>예산</Form.Label>
                    ...
                    <Form.InputGroup className={'w-full'}>
                        <Form.Label htmlFor={'introducedBy'} required>유입경로</Form.Label>
                ...
                <Form.InputGroup className={'mt-7'}>
                    <Form.Label htmlFor={'description'} required>프로젝트 설명</Form.Label>
                    <Form.Textarea id={'description'}  {...register("description", {required: true})} placeholder="text" className={'h-[190px]'} />
                </Form.InputGroup>

                <button className={'p-4 disabled:cursor-not-allowed cursor-pointer border mt-10 border-gray-500 transition-all duration-300 hover:bg-white hover:text-black'} type={'submit'}>제출하기</button>
